...
from src.controllers.views import (
    ...
    PerfilCliente, PerfilPro, UpdateUserC, UpdateUserP, Services, Disponibilidade
)
...
disponibilidade = Disponibilidade.as_view('disponibilidade')
...
routes = {
    ...
    "disponibilidade_route": "/disponibilidade",
